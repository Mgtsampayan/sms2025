...
const AnnouncementListPage = () => {
  const renderRow = (item: Announcement) => (
    ...
    >
      <td className="flex items-center gap-4 p-4 text-gray-900 dark:text-dark-text">
        {item.title}
      </td>
      <td className="text-gray-700 dark:text-gray-300">{item.class}</td>
  ...
  return (
    <div className="bg-white dark:bg-dark-card p-4 rounded-md flex-1 m-4 mt-0">
      ...
      <div className="flex items-center justify-between">
        <h1 className="hidden md:block text-lg font-semibold text-gray-900 dark:text-dark-text">
          All Announcements
        </h1>
