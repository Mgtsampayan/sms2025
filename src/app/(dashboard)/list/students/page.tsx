...
const StudentListPage = () => {
  const renderRow = (item: Student) => (
    ...
    >
      ...
      <td className="hidden md:table-cell dark:text-gray-300">{item.studentId}</td>
      ...
      <td>
        <div className="flex items-center gap-2">
          <Link href={`/list/students/${item.id}`}>
            <button className="w-7 h-7 flex items-center justify-center rounded-full bg-lamaSky dark:bg-sky-600 dark:hover:bg-sky-500">
