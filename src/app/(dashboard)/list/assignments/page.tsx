...
const AssignmentListPage = () => {
  const renderRow = (item: Assignment) => (
    ...
    >
      <td className="flex items-center gap-4 p-4 dark:text-gray-300">{item.subject}</td>
      <td className="dark:text-gray-300">{item.class}</td>
      <td className="hidden md:table-cell dark:text-gray-300">{item.teacher}</td>
      <td className="hidden md:table-cell dark:text-gray-300">{item.dueDate}</td>
      <td>
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex flex-col md:flex-row items-center gap-4 w-full md:w-auto">
          ...
          <div className="flex items-center gap-4 self-end">
            <button className="w-8 h-8 flex items-center justify-center rounded-full bg-lamaYellow dark:bg-yellow-600">
