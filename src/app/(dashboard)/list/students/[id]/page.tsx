      ...
      <div className="w-full xl:w-1/3 flex flex-col gap-4">
        <div className="bg-white dark:bg-dark-card p-4 rounded-md">
          ...
          <div className="mt-4 flex gap-4 flex-wrap text-xs text-gray-500 dark:text-gray-400">
            <Link className="p-3 rounded-md bg-lamaSkyLight dark:bg-gray-700 dark:text-gray-300" href="/">
              Student&apos;s Lessons
            </Link>
            <Link className="p-3 rounded-md bg-lamaPurpleLight dark:bg-gray-700 dark:text-gray-300" href="/">
              Student&apos;s Teachers
            </Link>
            <Link className="p-3 rounded-md bg-pink-50 dark:bg-gray-700 dark:text-gray-300" href="/">
              Student&apos;s Exams
            </Link>
            <Link className="p-3 rounded-md bg-lamaSkyLight dark:bg-gray-700 dark:text-gray-300" href="/">
              Student&apos;s Assignments
            </Link>
            <Link className="p-3 rounded-md bg-lamaYellowLight dark:bg-gray-700 dark:text-gray-300" href="/">
              Student&apos;s Results
            </Link>
          </div>
        </div>
